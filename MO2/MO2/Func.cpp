...
double Func::func(double* x)
{
   ...
   return -2 / ( 1 + ( x[0] - 1 ) * ( x[0] - 1 ) / 4.0 + ( x[1] - 2 ) * ( x[1] - 2 ) ) - 1 / ( 1 + ( x[0] - 3 ) * ( x[0] - 3 ) / 9.0 + ( x[1] - 1 ) * ( x[1] - 1 ) / 9.0 );
}
...
double* Func::gradFunc(double* x)
{
   ...
   double g1 = 1.0 + ( x1 - 1.0 ) * ( x1 - 1.0 ) / 4.0 + ( x2 - 2.0 ) * ( x2 - 2.0 );
   ...
   double dfdy_plus = -4.0 * ( x2 - 2.0 ) / ( g1 * g1 ) - 2.0 * ( x2 - 1.0 ) / ( 9.0 * g2 * g2 );
