...
void SLE::InputProperty( )
{
   ...
   if ( !file.is_open( ) ) throw std::runtime_error( "The file \"property.txt\" cannot be opened!" );
...
void SLE::InputSLE( )
{
   ...
   if ( !file.is_open( ) ) throw std::runtime_error( "The file \"ig.txt\" cannot be opened!" );
   ...
   if ( !file.is_open( ) ) throw std::runtime_error( "The file \"jg.txt\" cannot be opened!" );
   ...
   if ( !file.is_open( ) )throw std::runtime_error( "The file \"gg.txt\" cannot be opened!" );
   for ( size_t i = 0; i < buf; ++i )
      file >> matrix.ggl[i];
   file.close( );
   //---------------------------------------------------------------------------------
   file.open( "C:\\NumMeth\\data\\di.txt" );
   if ( !file.is_open( ) ) throw std::runtime_error( "The file \"di.txt\" cannot be opened!" );
   ...
   if ( !file.is_open( ) ) throw std::runtime_error( "The file \"f.txt\" cannot be opened!" );
